    ...
    <div class="container">
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              ...
              <br>
              Mail : Travelwithmeoffcial@gmail.com <br>
              Contact No: 9845256246 <br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong>Objective</strong></h4><hr>
                <br>
                Our Motto is to give value differentiator in teams of quickest search and booking, fast payments, settlements or refund processes <br>
